...
class JobDescription(Base):
    ...
    jd_file_url: Mapped[str | None] = mapped_column(String(500))
    jd_s3_key: Mapped[str | None] = mapped_column(String(500))
    status: Mapped[str] = mapped_column(String(50), default=JDStatus.ACTIVE.value)

    # AI Extracted fields
    required_skills: Mapped[dict | None] = mapped_column(JSONB)   # list of strings
    preferred_skills: Mapped[dict | None] = mapped_column(JSONB)
